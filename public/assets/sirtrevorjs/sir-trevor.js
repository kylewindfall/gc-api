  ...
  */
  ...
  SirTrevor.BlockReorder = (function(){
    ...
    _.extend(BlockReorder.prototype, FunctionBind, Renderable, {
      ...
      className: 'st-block-ui-btn st-block-ui-btn--reorder',
      tagName: 'a',
  
      attributes: function() {
        return {
          'html': '<i class="icon-cursor-move icons"></i>',
          'draggable': 'true',
          'data-icon': ''
        };
      },
  ...
  SirTrevor.BlockDeletion = (function(){
    ...
    _.extend(BlockDeletion.prototype, FunctionBind, Renderable, {
      ...
      tagName: 'a',
      className: 'st-block-ui-btn st-block-ui-btn--delete',
  
      attributes: {
        html: '<i class="icon-trash icons"></i>',
        'data-icon': ''
      }
  ...
  SirTrevor.Block = (function(){
    ...
    var delete_template = [
      "<div class='st-block__ui-delete-controls'>",
        ...
        "</label>",
        "<a class='st-block-ui-btn st-block-ui-btn--confirm-delete'><i class='icon-check icons'></i></a>",
        "<a class='st-block-ui-btn st-block-ui-btn--deny-delete'><i class='icon-close icons'></i></a>",
      "</div>"
    ].join("\n");
  ...
  */
  ...
  SirTrevor.Blocks.Quote = (function(){
    ...
    var template = _.template([
      ...
      ' class="st-input-string st-required js-cite-input lineunder" type="text" />'
    ].join("\n"));
  ...
  */
  ...
  SirTrevor.FloatingBlockControls = (function(){
    ...
    _.extend(FloatingBlockControls.prototype, FunctionBind, Renderable, SirTrevor.Events, {
      ...
      className: "st-block-controls__top icon-plus icons",
